...
uninstall:
	rm -rf /usr/bin/ansible-check-insights
	rm -rf /usr/share/ansible-check-insights/plugins/action_plugins/check.py
	rm -rf /usr/share/ansible-check-insights/plugins/callback_plugins/notify_insights.py
	rm -rf /usr/share/ansible-check-insights/plugins/library/check.py
	rm -rf /usr/share/ansible-check-insights
